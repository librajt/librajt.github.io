---
layout: post
title: "用LESS递归生成CSS KEYFRAMES制作自动轮播的幻灯片"
description: "lll"
category: fe
...
#cube-animation 工具中包含两部分：生成 keyframes 的代码、生成 init 初始化静止状态的代码。

生成 keyframes 的代码中，核心是 .vertical ，它用来生成各 keyframe，它生成了垂直方向上轮播的代码。
